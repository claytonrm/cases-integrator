...
public class FullIndexCriteriaStrategy extends FilterCriteria implements CriteriaStrategy {

    public FullIndexCriteriaStrategy(final CaseCriteria criteria, final CaseRepository repository) {
